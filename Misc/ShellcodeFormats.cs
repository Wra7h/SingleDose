...
namespace SingleDose.ShellcodeFormats
{
    public class SRDI
    {
        /// <summary>
        /// Retrieve the SRDI configuration items from the user and build the shellcode to be implemented
        /// </summary>
        /// <param name="path"> the path to the dll that will be converted to shellcode</param>
        /// <returns></returns>
        public static byte[] Generate(string path)
        {
            ...
            Console.WriteLine("|   [OPTIONAL] Enter the name of an exported function to call after DLLMain:");
            Console.Write("|       > ");
    ...
    public class Shellcode
    {
        ...
        {
            if (Program.shellcodeHistory.Count == 0)
            {
                return; //Nothing to see here
            }
            Console.WriteLine("|\n|            +----------------+");
            Console.WriteLine("|            | INJECT HISTORY |");
            Console.WriteLine("|            +----------------+");
            for (int i = 0; i < Program.shellcodeHistory.Count; i++)
            {
                Console.WriteLine("|   H{0}: {1} [Size: {2}]", i+1, Program.shellcodeHistory[i].Path, Program.shellcodeHistory[i].Shellcode.Length);
            }
            Console.WriteLine("|");
        }
    }
